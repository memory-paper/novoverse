# cmd =  gem5/build/ARM_MESI_Three_Level/gem5.opt /home/yons/lin/workspace/novoverse/scripts/microbench_reproduce.py  Novoverse octopi  hsjshjshj y zero
...
def run_microbench(inputs):
    ...
    with open(os.path.join(m5.options.outdir, "benchmark"), "w") as outfile:
        outfile.writelines([f"Benchmark: {binary}"])
